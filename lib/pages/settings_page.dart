                      ...
                      children: <Widget>[
                        ...
                        UnitSelectionWidget<Imperial>(
                          ...
                          onTap: (val) {
                            ...
                            // show toast message
                            settingsController.showToast(
                                'Unit changed to ${settingsController.getImperial()}');

                            // store the selected unit in shared preferences
                            Preference.setString(kKeyImperialValue,
                                settingsController.selectedImperial.toString());
                        ...
                        UnitSelectionWidget<Metric>(
                          ...
                          onTap: (val) {
                            ...
                            // show toast message
                            settingsController.showToast(
                                'Unit changed to ${settingsController.getMetric()}');

                            // store the selected unit in shared preferences
                            Preference.setString(kKeyMetricValue,
                                settingsController.selectedMetric.toString());
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => const TermsConditions(
                                  url:
                                      'bmi.solobit.dev/terms_and_condition.html',
